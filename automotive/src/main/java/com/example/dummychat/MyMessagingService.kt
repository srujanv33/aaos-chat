...
const val READ_ACTION = "com.example.dummychat.ACTION_MESSAGE_READ"
const val REPLY_ACTION = "com.example.dummychat.ACTION_MESSAGE_REPLY"
...
class MyMessagingService : Service() {
    ...
    internal inner class IncomingHandler : Handler(Looper.myLooper()!!) {
        override fun handleMessage(msg: Message) {
            sendNotification(1, "Test message ", "Srujan V", System.currentTimeMillis())
        }
    }
}